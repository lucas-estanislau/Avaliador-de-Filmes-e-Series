...
@FuncionamentoClasse(funcionamento="Classe responsável por ler as mídias no database.")
public class Leitor {
	...
	@FuncionamentoMetodo(funcionamento = "Método que ler o arquivo e separa em duas listas: de filme e série. Além de também tratar caso tenha menos campos que o mínimo.")
			...
			while ((linha = br.readLine()) != null) {
				...
				try {
					...
					if (tipo.equalsIgnoreCase("FILME")) {
						...
						Filme filme = new Filme(titulo, genero, sinopse, classificacao_indicativa, data_de_lancamento,
								diretor, duracao);
						filmes.add(filme);
						...
						Serie serie = new Serie(titulo, genero, sinopse, classificacao_indicativa, data_de_lancamento,
